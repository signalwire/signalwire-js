...
const _finishedEvents: string[] = [
  CallDetectState.Error,
  CallDetectState.Finished,
]
const _machineStateEvents: string[] = [
  CallDetectState.Ready,
  CallDetectState.NotReady,
]
