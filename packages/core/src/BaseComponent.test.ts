...
describe('BaseComponent', () => {
  describe('as an event emitter', () => {
    ...
    it('should properly apply nested transforms', () => {
      ...
      const instance = new CustomComponent()
      const payload = {
        call_id: '28a20c71-43d4-443f-85d6-8ce3199b192b',
        member_id: '28a20c71-43d4-443f-85d6-8ce3199b192b',
        room_session: {
          room_id: 'b5bc21f7-ccd1-41c8-9c72-db4d16783048',
          id: '2aeca1a3-c22d-4a29-b422-cf562bcc6853',
          event_channel: 'EC_78b616ce-214f-427f-bf82-af4c0bfffadc',
          name: 'testing-positions',
          recording: true,
          hide_video_muted: false,
          layout_name: 'grid-responsive',
          display_name: 'testing-positions',
          meta: {},
          recordings: [
            {
              id: '9580c366-f438-42ac-ab94-c6bbeca29d51',
              state: 'recording',
              duration: null,
              started_at: 1650449237.568,
              ended_at: null,
            },
          ],
          members: [
            {
              id: 'ca9976e9-4caa-4bb4-8be1-b8e66ada641a',
              room_id: 'b5bc21f7-ccd1-41c8-9c72-db4d16783048',
              room_session_id: '2aeca1a3-c22d-4a29-b422-cf562bcc6853',
              name: 'fran',
              type: 'member',
              parent_id: '',
            ...
            {
              id: '28a20c71-43d4-443f-85d6-8ce3199b192b',
              room_id: 'b5bc21f7-ccd1-41c8-9c72-db4d16783048',
              room_session_id: '2aeca1a3-c22d-4a29-b422-cf562bcc6853',
              name: 'fran',
              type: 'member',
