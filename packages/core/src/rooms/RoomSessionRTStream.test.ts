...
} from './RoomSessionRTStream'

describe('RoomSessionRTStream', () => {
  describe('createRoomSessionRTStreamObject', () => {
    let instance: RoomSessionRTStream
    beforeEach(() => {
      instance = createRoomSessionRTStreamObject({
