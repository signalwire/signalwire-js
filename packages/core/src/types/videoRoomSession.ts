...
export type RoomAudienceCount = 'room.audience_count'

// Generated by the SDK
export type RoomJoined = 'room.joined'
export type RoomAudienceCountCamelCase = 'room.audienceCount'
...
export interface InternalVideoRoomAudienceCountEvent extends SwEvent {
  event_type: ToInternalVideoEvent<RoomAudienceCountCamelCase>
